...
class TicketController
{
    ...
    public static function AddCreditCard(
        ...
        try {
            ...
            ViewsController::setAlerts($aex->getExceptionArray());
        } catch (Exception $th) {
            ViewsController::setAlerts(array('Error processing request'));
            HomeController::Index();
            exit;
    ...
    {
        sleep(5);
        ViewsController::setAlerts(array('Recived authorization'));
    ...
    public static function List(String $movieName = "", String $date = "", String $orderby = "none")
    {
        ...
        ViewsController::TicketList(Session::GetCurrentUser(), $tickets, $movieName, $date, $orderby);
    }
}
