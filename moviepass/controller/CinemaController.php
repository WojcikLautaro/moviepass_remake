...
class CinemaController
{
    ...
    public function AddCinema($nameCinema, $address, $openingTime, $closingTime, $ticketValue, $capacity)
    {
        ...
        if ($hasError == false) {
            ...
            ViewsController::Show(["Error:", $errorMessage]);
    ...
    public function ShowCinemas()
    {
        ...
        if ($cinemaList == null)
            ViewsController::Show(["Alert:", "There is no cinema entered"]);
    ...
    public function DeleteCinema($deleteId)
    {
        if (!FunctionsDAO::getAllFromCinema($deleteId)) {
            ...
            if ($delete == true)
                ViewsController::Show(["Message:", "Cinema removed"]);
        } else
            ViewsController::Show(array("The cinema cannot be deleted because it has loaded functions"));
        require_once(VIEWS_PATH . 'indexCinema.php');
    }
